                    ...
                    <div className="backdrop-blur-[40px] bg-white/[0.03] border border-white/10 rounded-[2.5rem] p-10 md:p-14 shadow-[0_40px_100px_rgba(0,0,0,0.5)] relative overflow-hidden group">
                        ...
                        <form onSubmit={handleLoginSubmit} className="space-y-6">
                            ...
                            <button 
                                ...
                                className="w-full py-5 bg-gradient-to-r from-[#D4AF37] to-[#2A3B1B] text-black font-black uppercase text-[11px] tracking-[0.3em] rounded-2xl shadow-[0_10px_30px_rgba(0, 240, 255,0.2)] hover:shadow-[0_15px_40px_rgba(0, 240, 255,0.3)] hover:-translate-y-1 active:translate-y-0 transition-all duration-300 mt-2"
                            >
